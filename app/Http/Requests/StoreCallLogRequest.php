...
class StoreCallLogRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'contact_source' => ['required', 'in:gumtree,spareroom,zoopla,rightmove,referral,other'],
            
            // Property Details
            'property_address' => ['required', 'string', 'max:500'],
            'property_type' => ['required', 'in:studio,one_bed,two_bed,hmo,other'],
            'advertised_rent' => ['required', 'numeric', 'min:0', 'max:99999.99'],
            'availability_date' => ['nullable', 'date'],
            'vacant_keys' => ['boolean'],
            'furnished' => ['required', 'in:furnished,unfurnished,part_furnished,other'],
            ...
            'landlord_priority' => ['required', 'in:speed,best_price,hands_off,other'],
            'discovery_notes' => ['nullable', 'string'],
            
            // Offer Presentation
            'packages_discussed' => ['nullable', 'array'],
            'landlord_preference' => ['required', 'in:full_management,top_up,let_only,undecided'],
            ...
            'next_step_status' => ['required', 'in:send_terms,send_compliance_docs,awaiting_response,collect_keys,tenant_reference_started,other'],
