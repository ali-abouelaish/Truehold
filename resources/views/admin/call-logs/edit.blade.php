    ...
    <form method="POST" action="{{ route('admin.call-logs.update', $callLog) }}" class="bg-white shadow rounded-lg p-6">
        ...
        <div class="mb-8">
            ...
            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                <p class="text-sm text-blue-800 mb-3">Check if this phone number has been called before.</p>
                <div class="relative">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="number" name="number_of_beds" id="number_of_beds" min="0" max="20" 
                           value="{{ old('number_of_beds', $callLog->number_of_beds) }}" 
                           class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="number_of_bathrooms" id="number_of_bathrooms" min="0" max="10" 
                           value="{{ old('number_of_bathrooms', $callLog->number_of_bathrooms) }}" 
                           class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="url" name="room_link" id="room_link" 
                           value="{{ old('room_link', $callLog->room_link) }}" 
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const currentCallLogId = {{ $callLog->id }};
    ...
    function checkPhoneNumber(phone) {
        ...
        phoneCheckTimeout = setTimeout(() => {
            fetch(`/admin/call-logs/check-phone?phone=${encodeURIComponent(phone)}&exclude_id=${currentCallLogId}`, {
                method: 'GET',
                headers: {
    ...
    function showPreviousCalls(phone) {
        fetch(`/admin/call-logs/previous-calls?phone=${encodeURIComponent(phone)}&exclude_id=${currentCallLogId}`, {
            method: 'GET',
            headers: {
                'X-Requested-With': 'XMLHttpRequest',
                'Accept': 'application/json',
