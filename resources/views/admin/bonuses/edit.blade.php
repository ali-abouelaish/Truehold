...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto">
        <div class="mb-6">
            <h1 class="text-3xl font-bold text-gray-900">Edit Bonus Record</h1>
            <p class="mt-2 text-sm text-gray-600">Update the bonus record details for {{ $bonus->agent->display_name }}.</p>
        </div>
        ...
        <form action="{{ route('admin.bonuses.update', $bonus) }}" method="POST" class="bg-white shadow-lg rounded-lg p-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="date" 
                           id="date" 
                           name="date" 
                           value="{{ old('date', $bonus->date->format('Y-m-d')) }}"
                ...
                <div>
                    ...
                    <input type="text" 
                           id="landlord" 
                           name="landlord" 
                           value="{{ old('landlord', $bonus->landlord) }}"
                ...
                <div>
                    ...
                    <input type="text" 
                           id="property" 
                           name="property" 
                           value="{{ old('property', $bonus->property) }}"
                ...
                <div>
                    ...
                    <input type="number" 
                           ...
                           value="{{ old('full_commission', $bonus->full_commission) }}"
                           step="0.01"
                           min="0"
                ...
                <div>
                    ...
                    <input type="number" 
                           ...
                           value="{{ old('agent_commission', $bonus->agent_commission) }}"
                           step="0.01"
                           min="0"
            ...
            <div class="mt-6">
                <div class="flex items-center">
                    <input type="checkbox" 
                           ...
                           value="1"
                           {{ old('invoice_sent_to_management', $bonus->invoice_sent_to_management) ? 'checked' : '' }}
            ...
            <div class="mt-6">
                ...
                <textarea id="notes" 
                          ...
                          placeholder="Enter any additional notes">{{ old('notes', $bonus->notes) }}</textarea>
                @error('notes')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
