                    ...
                    <form method="POST" action="{{ route('admin.ap-properties.update', $property) }}" enctype="multipart/form-data">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6 form-check mt-2">
                                ...
                                <input type="checkbox" id="is_room" name="is_room" value="1" class="form-check-input" {{ old('is_room', $property->is_room) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6 form-check mt-2">
                                ...
                                <input type="checkbox" id="couples_allowed" name="couples_allowed" value="1" class="form-check-input" {{ old('couples_allowed', $property->couples_allowed) ? 'checked' : '' }}>
