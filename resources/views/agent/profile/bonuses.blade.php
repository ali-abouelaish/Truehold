...
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold text-gray-900">Bonus Records</h1>
        <a href="{{ route('agent.profile.bonuses.create') }}" 
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex space-x-2">
                                    ...
                                    <form action="{{ route('agent.profile.bonuses.destroy', $bonus) }}" 
    ...
    @else
        <div class="text-center py-12">
            ...
            <h3 class="mt-2 text-sm font-medium text-gray-900">No bonus records</h3>
            <p class="mt-1 text-sm text-gray-500">Get started by creating a new bonus record.</p>
            <div class="mt-6">
                <a href="{{ route('agent.profile.bonuses.create') }}" 
