...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto">
        <div class="mb-6">
            <h1 class="text-3xl font-bold text-gray-900">Add New Payment Record</h1>
            <p class="mt-2 text-sm text-gray-600">Create a new payment record for your earnings.</p>
        </div>
        ...
        <form action="{{ route('agent.profile.payments.store') }}" method="POST" class="bg-white shadow-lg rounded-lg p-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select id="type" 
                        ...
                        <option value="letting_deal" {{ old('type') == 'letting_deal' ? 'selected' : '' }}>Letting Deal</option>
            ...
            <div class="mt-6">
                <div class="flex items-center">
                    <input type="checkbox" 
                           ...
                           value="1"
                           {{ old('invoice_sent_to_management') ? 'checked' : '' }}
