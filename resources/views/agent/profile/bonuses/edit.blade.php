...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto">
        <div class="mb-6">
            ...
            <p class="mt-2 text-sm text-gray-600">Update the bonus record details.</p>
        </div>
        ...
        <form action="{{ route('agent.profile.bonuses.update', $bonus) }}" method="POST" class="bg-white shadow-lg rounded-lg p-6">
            @csrf
            @method('PUT')
