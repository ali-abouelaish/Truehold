...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto">
        <div class="mb-6">
            <h1 class="text-3xl font-bold text-gray-900">Add New Bonus Record</h1>
            <p class="mt-2 text-sm text-gray-600">Create a new bonus record for your earnings.</p>
        </div>
        ...
        <form action="{{ route('agent.profile.bonuses.store') }}" method="POST" class="bg-white shadow-lg rounded-lg p-6">
            @csrf
